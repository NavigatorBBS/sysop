...
class NotebookChatAgent:
    ...
    def __init__(
        ...
        default_system = (
            ...
            "suggest improvements for financial data processing, and help with "
            "transaction categorization. "
            "\n\n"
            "**IMPORTANT**: Always format your responses using Markdown. Use: "
            "headers (#, ##, ###), **bold** and *italic*, `code` blocks, lists, "
            "and tables. "
            "Always explain your suggestions clearly and provide code examples "
            "when relevant."
        )
